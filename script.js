...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Ensure root-relative nav links (prevents accidental hash navigation)
    navLinks.forEach(link => {
        const href = link.getAttribute('href');
        if (!href) return;
        if (href === 'news.html' || href === './news.html') link.setAttribute('href', '/news.html');
        if (href === 'about.html' || href === './about.html') link.setAttribute('href', '/about.html');
        if (href === 'services.html' || href === './services.html') link.setAttribute('href', '/services.html');
        ...
        if (normalizedHref && normalizedHref.endsWith('/news.html')) {
